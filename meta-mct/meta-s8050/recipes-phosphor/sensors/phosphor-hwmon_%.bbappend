...
EXTRA_OEMESON_append_s8050 = " -Dupdate-functional-on-fail=false -Dnegative-errno-on-fail=false"
...
SYSTEMD_ENVIRONMENT_FILE_${PN}_append_s8050 += " ${@compose_list(d, 'ENVS_SHALE64', 'ITEMS_SHALE')}"
ENVS_CINNABAR = "obmc/hwmon_cinnabar/{0}"
SYSTEMD_ENVIRONMENT_FILE_${PN}_append_s8050 += " ${@compose_list(d, 'ENVS_CINNABAR', 'ITEMS_CINNABAR')}"
ENVS_SUNSTONE = "obmc/hwmon_sunstone/{0}"
SYSTEMD_ENVIRONMENT_FILE_${PN}_append_s8050 += " ${@compose_list(d, 'ENVS_SUNSTONE', 'ITEMS_SUNSTONE')}"
