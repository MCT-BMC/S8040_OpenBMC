...
SRC_URI = "git://git@micgitlab1-ssh.mic.com.tw:1022/grdc/rdc5/rdd2/bmc/openbmc/amd/amd-power-control.git;branch=integ;protocol=ssh"
#SRCREV = "${AUTOREV}"
SRCREV = "b15942d579df0292fe170165bb1910f620d0af20"
